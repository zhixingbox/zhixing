...
**《森林守护者：小红帽的冒险之旅》** 是一款互动视频项目，以 AI 驱动，面向教育行业。
基于 XBuilder 开发平台与 XGoPilot 工具实现。
项目选择了通俗易懂的少儿故事为基础改编，以同时贴近终端儿童用户和教育行业。
AI会生成剧情选项给观众，并根据观众的选择，会记录 MBTI 数值，并最终给出性格分析，生成不同的动画。
本项目的核心目标是，通过将当下流行的互动视频 与 AI / Go+ / XBuilder 相结合，在业务上突显 Go+ / XBuilder 多样可能性与市场价值。最终促进客户接入 Go+ / XBuilder，或接入七牛 AI 生态并消费 token。
...
- 采用 **Go+** 编程语言，语法简洁易学，跨平台支持更好，将来面向实践工作跨度小
- 事件驱动编程模型，贴近现代软件开发思维
